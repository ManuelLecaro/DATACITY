  ...
  d3.queue()
    ...
    if (error) {
      ...
      */
      ...
      if (getMultiTimeSeriesPluginSize(size) == 7) { vis.call(tip); }
      ...
      */
      ...
      function common_behaviour() {
          ...
          focus.select(".area2").attr("d", area);
        	...
        	focus.select(".area_missing2").attr("d", area_missing);
            focus.select(".line_missing2").attr("d", line_missing);
  focus.selectAll(".dot2")
        		.attr("cx", function(d) { return x(d.month); })
        		.attr("cy", function(d) { return y(d.count); });
          // dataset3
          focus.select(".area3").attr("d", area);
        	...
        	focus.select(".area_missing3").attr("d", area_missing);
            focus.select(".line_missing3").attr("d", line_missing);
  focus.selectAll(".dot3")
        		.attr("cx", function(d) { return x(d.month); })
        		.attr("cy", function(d) { return y(d.count); });
      };
